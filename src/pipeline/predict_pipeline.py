...
class PredictPipeline:
    ...
    def predict(self,features):  #method to make predictions.
        try:
...
class CustomData:    #class to handle user input data.
    def __init__( self,
        gender: str,
        race_ethnicity: str,
    ...
    def get_data_as_data_frame(self):  #method to convert user input data to pandas dataframe.
        try:
